                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($item->transaction_status == 'PENDING'): ?>
                                                    ...
                                                    <a href=" <?php echo e(route('transactions.status', $item->id)); ?>?status=FAILED" class="btn btn-warning btn-sm">
                                                ...
                                                <form action="<?php echo e(route('transactions.destroy', $item->id)); ?> " method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Shadif\Documents\jastip-app-backend\resources\views/pages/transactions/index.blade.php ENDPATH**/ ?>